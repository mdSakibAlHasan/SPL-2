  ...
  useEffect(() => {
    async function handleSuggesion() {
      const result2 = await axios.post(
        "http://localhost:3001/RD/getCommitteeSuggession"
      ...
      if (info && info[0].type === "admin") {
        ...
        info &&
        (info[0].type === "Director" || info[0].type === "PI")
      ) {
  ...
  return (
    <div className="full_page_normal p-5 shade1">
      <div className="shade2 p-5 rounded">
        <center>
          <h4>{tittle}</h4> <hr />
          <h5 className="p-2">Select your researcher</h5>
        </center>
        <div>
          <div className="row">
            <div style={{ display: "flex" }}>
              {suggesionArr.map((user) => (
                <ProfileCard
                  key={user.ID}
                  name={user.Name}
        ...
        {researcherName && (
          <p>{researcherName} is selected as research co-ordinatore</p>
        )}
            ...
            <div className="modal-dialog" role="document">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <p>
                    Are you sure you want to add {researcherName} as a committee
                    member?
                  </p>
                  <div>
